...
../scripts/run_inference.py inference.output_prefix=example_outputs/design_tnfr inference.input_pdb=input_pdbs/7KP8.pdb 'contigmap.contigs=[F14-139/0 65-65]' 'ppi.hotspot_res=[F67,F70,F95,F112]' inference.num_designs=10 denoiser.noise_scale_ca=0 denoiser.noise_scale_frame=0
