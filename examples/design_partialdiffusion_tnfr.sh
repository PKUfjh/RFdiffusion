...
../scripts/run_inference.py inference.output_prefix=example_outputs/design_partialdiffusion_tnfr inference.input_pdb=input_pdbs/design_tnfr_extended_2_dldesign_3_af2pred.pdb 'contigmap.contigs=["120-120/0 B121-246"]' diffuser.partial_T=15 inference.num_designs=100 'potentials.guiding_potentials=["type:interface_ncontacts,weight:0.5"]'
